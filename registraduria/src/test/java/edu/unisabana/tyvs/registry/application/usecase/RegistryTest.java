...
public class RegistryTest {
    ...
    /**
     * Caso de prueba:
     * <p>Una persona menor de edad (menor a 18 años) debe ser rechazada.</p>
     */
    @Test
    ...
    /**
     * Caso de prueba:
     * <p>Una persona fallecida debe ser rechazada.</p>
     */
    @Test
    public void shouldRejectDeadPerson() throws Exception {
        // Arrange
        Person p = new Person("Carlos", 102, 50, Gender.MALE, false);
     ...
     */
    @Test
    public void shouldRejectInvalidPerson() throws Exception {
        // Arrange
        Person p = new Person("Pedro", -5, 20, Gender.MALE, true);
